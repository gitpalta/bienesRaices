<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        $titulo = mysqli_real_escape_string( $db, $_POST['titulo'] ); //esta funcion escapa a peligros que pueden darse en la entrada de formularios
        ...
        if (strlen ($descripcion) < 20 ){
            $errores[] = "Debes añadir una descripción de al menos 20 carácteres";
        }
        ...
        //validar por tamaño (1mb máximo) php limita por default a 2Mb
        $medida = 1000 * 1000; // pasa bits a kilobites
        ...
        if (empty($errores)) {
            ...
            if ($resultado) {
                //redireccionar al usuario para que no reingrese formulario
